...
protected:
  ...
  // Precomputed waveform tables (shared across instances).
  static reg8 wave6581__ST[1 << 12];
  static reg8 wave6581_P_T[1 << 12];
  static reg8 wave6581_PS_[1 << 12];
  static reg8 wave6581_PST[1 << 12];
  static reg8 wave8580__ST[1 << 12];
  static reg8 wave8580_P_T[1 << 12];
  static reg8 wave8580_PS_[1 << 12];
  static reg8 wave8580_PST[1 << 12];
